...
const Projects = () => {
  ...
  const projects = [
    ...
    {
      title: 'Gesture Echo',
      description: 'Real-time hand sign language to speech translation system for accessibility.',
      technologies: ['Python', 'OpenCV', 'TensorFlow', 'Google Cloud', 'Git'],
      points: [
        'Developed a real-time hand sign language to speech translation system with 97% accuracy using a compact ResNet-18 model.',
        'Integrated Google Text-to-Speech API for seamless real-time audio translation with high user accessibility.',
        'Optimized model for low-latency output, achieving translation speeds of 200 ms on low-end devices.'
      ]
    }
  ];
