    ...
    <section className="section" id="home" style={{ height: '100vh', display: 'flex', alignItems: 'center' }}>
      <div className="container">
        ...
        <motion.div
            ...
            >
            <a 
                href="https://github.com/aryann-anand" 
                target="_blank" 
            ...
            <a 
                href="https://www.linkedin.com/in/aryananand18/" 
                target="_blank" 
                rel="noopener noreferrer"
                style={{
                color: 'var(--color-text)',
            ...
            <a 
                href="https://www.kaggle.com/aryan0000" 
                target="_blank" 
                rel="noopener noreferrer"
                style={{
                color: 'var(--color-text)',
            ...
            <a 
                href="https://drive.google.com/drive/folders/1cbJZQpSbYw38PkB41VJAP0Ncw7S7Ejzi?usp=sharing" 
                target="_blank" 
                rel="noopener noreferrer"
                style={{
                color: 'var(--color-text)',
