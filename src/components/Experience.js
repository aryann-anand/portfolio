  ...
  const experiences = [
    {
      ...
      company: 'IIT Bombay, TIH for IoT & IoE',
      period: 'Sept 2023 - Dec 2023',
      description: [
        'Conducted Data Cleaning, Data Preprocessing, Data Augmentation, Transformations on big data images dataset.',
        'Applied Hyperparameter Tuning and Fine-tuning to deploy Image Segmentation Model on automated pipeline.',
        'Developed a deep learning neural network using custom U2-Net for automated image masking, feature extraction, and background removal, improving the validation accuracy of a deployed industrial predictive model by 24%.',
